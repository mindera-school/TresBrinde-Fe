...
export const ListProductsAction =
  (limit: number, specificCategory: string, categoryCheck: boolean) =>
  async (dispatch: Dispatch) => {
    dispatch(listProductsRequestAction());

    getListProductsService(limit, specificCategory, categoryCheck).then(
      (data) => {
...
export const CreateProductAction =
  (product: any, history: any) => async (dispatch: Dispatch) => {
...
export const DetailsProductAction =
